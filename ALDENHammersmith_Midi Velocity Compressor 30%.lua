-- MIDI Velocity Compression 20%
-- Scales selected MIDI note velocities down by 20% (vel * 0.80).

local factor = 0.80  -- 20% reduction
...
reaper.Undo_EndBlock("MIDI Velocity Compression 20%", -1)
